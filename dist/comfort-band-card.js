...
const { is: te, defineProperty: ee, getOwnPropertyDescriptor: ie, getOwnPropertyNames: re, getOwnPropertySymbols: oe, getPrototypeOf: se } = Object, st = globalThis, Ct = st.trustedTypes, ne = Ct ? Ct.emptyScript : "", ae = st.reactiveElementPolyfillSupport, q = (e, t) => e, et = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? ne : null;
      break;
...
U.elementStyles = [], U.shadowRootOptions = { mode: "open" }, U[q("elementProperties")] = /* @__PURE__ */ new Map(), U[q("finalized")] = /* @__PURE__ */ new Map(), ae?.({ ReactiveElement: U }), (st.reactiveElementVersions ??= []).push("2.1.2");
const vt = globalThis, Tt = (e) => e, it = vt.trustedTypes, kt = it ? it.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Rt = "$lit$", k = `lit$${Math.random().toFixed(9).slice(2)}$`, Bt = "?" + k, ce = `<${Bt}>`, M = document, W = () => M.createComment(""), K = (e) => e === null || typeof e != "object" && typeof e != "function", _t = Array.isArray, le = (e) => _t(e) || typeof e?.[Symbol.iterator] == "function", dt = `[ 	
\f\r]`, V = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ot = /-->/g, Nt = />/g, D = RegExp(`>|${dt}(?:([^\\s"'>=/]+)(${dt}*=${dt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), zt = /'/g, Dt = /"/g, It = /^(?:script|style|textarea|title)$/i, Ft = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), a = Ft(1), Q = Ft(2), j = Symbol.for("lit-noChange"), p = Symbol.for("lit-nothing"), Ht = /* @__PURE__ */ new WeakMap(), H = M.createTreeWalker(M, 129);
function Vt(e, t) {
...
const he = (e, t) => {
  ...
  let o, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", n = V;
  for (let h = 0; h < i; h++) {
    const c = e[h];
    let f, u, d = -1, v = 0;
    for (; v < c.length && (n.lastIndex = v, u = n.exec(c), u !== null); ) v = n.lastIndex, n === V ? u[1] === "!--" ? n = Ot : u[1] !== void 0 ? n = Nt : u[2] !== void 0 ? (It.test(u[2]) && (o = RegExp("</" + u[2], "g")), n = D) : u[3] !== void 0 && (n = D) : n === D ? u[0] === ">" ? (n = o ?? V, d = -1) : u[1] === void 0 ? d = -2 : (d = n.lastIndex - u[2].length, f = u[1], n = u[3] === void 0 ? D : u[3] === '"' ? Dt : zt) : n === Dt || n === zt ? n = D : n === Ot || n === Nt ? n = V : (n = D, o = void 0);
    const T = n === D && e[h + 1].startsWith("/>") ? " " : "";
    s += n === V ? c + ce : d >= 0 ? (r.push(f), c.slice(0, d) + Rt + c.slice(d) + k + T) : c + k + (d === -2 ? h : T);
  }
  return [Vt(e, s + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class Z {
  constructor({ strings: t, _$litType$: i }, r) {
    ...
    if (this.el = Z.createElement(f, r), H.currentNode = this.el.content, i === 2 || i === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (o = H.nextNode()) !== null && c.length < h; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const d of o.getAttributeNames()) if (d.endsWith(Rt)) {
          const v = u[n++], T = o.getAttribute(d).split(k), Y = /([.?@])?(.*)/.exec(v);
          c.push({ type: 1, index: s, name: Y[2], strings: T, ctor: Y[1] === "." ? pe : Y[1] === "?" ? ue : Y[1] === "@" ? fe : nt }), o.removeAttribute(d);
        } else d.startsWith(k) && (c.push({ type: 6, index: s }), o.removeAttribute(d));
        if (It.test(o.tagName)) {
          const d = o.textContent.split(k), v = d.length - 1;
          if (v > 0) {
            o.textContent = it ? it.emptyScript : "";
            for (let T = 0; T < v; T++) o.append(d[T], W()), H.nextNode(), c.push({ type: 2, index: ++s });
            o.append(d[v], W());
          }
        }
        ...
        let d = -1;
        for (; (d = o.data.indexOf(k, d + 1)) !== -1; ) c.push({ type: 7, index: s }), d += k.length - 1;
      }
      s++;
    }
  }
...
class de {
  ...
  u(t) {
    const { el: { content: i }, parts: r } = this._$AD, o = (t?.creationScope ?? M).importNode(i, !0);
    H.currentNode = o;
    let s = H.nextNode(), n = 0, h = 0, c = r[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let f;
        c.type === 2 ? f = new X(s, s.nextSibling, this, t) : c.type === 1 ? f = new c.ctor(s, c.name, c.strings, this, t) : c.type === 6 && (f = new me(s, this, t)), this._$AV.push(f), c = r[++h];
      }
      n !== c?.index && (s = H.nextNode(), n++);
    }
    return H.currentNode = M, o;
  }
  p(t) {
    let i = 0;
...
class X {
  ...
  $(t) {
    const { values: i, _$litType$: r } = t, o = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Z.createElement(Vt(r.h, r.h[0]), this.options)), r);
  ...
  _$AC(t) {
    ...
    return i === void 0 && Ht.set(t.strings, i = new Z(t)), i;
  }
  k(t) {
    _t(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let r, o = 0;
    for (const s of t) o === i.length ? i.push(r = new X(this.O(W()), this.O(W()), this, this.options)) : r = i[o], r._$AI(s), o++;
...
be?.(Z, X), (vt.litHtmlVersions ??= []).push("3.3.2");
const ge = (e, t, i) => {
  const r = i?.renderBefore ?? t;
  let o = r._$litPart$;
  if (o === void 0) {
    const s = i?.renderBefore ?? null;
    r._$litPart$ = o = new X(t.insertBefore(W(), s), s, void 0, i ?? {});
  }
  return o._$AI(e), o;
};
const yt = globalThis;
...
const ve = yt.litElementPolyfillSupport;
ve?.({ LitElement: b });
...
const _e = { attribute: !0, type: String, converter: et, reflect: !1, hasChanged: gt }, ye = (e = _e, t, i) => {
...
function l(e) {
  return (t, i) => typeof i == "object" ? ye(e, t, i) : ((r, o, s) => {
...
const $e = (e, t, i) => (i.configurable = !0, i.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, i), i);
function at(e, t) {
  return (i, r, o) => {
...
var we = Object.defineProperty, xe = Object.getOwnPropertyDescriptor, J = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? xe(t, i) : t, s = e.length - 1, n; s >= 0; s--)
...
var Pe = Object.defineProperty, Te = Object.getOwnPropertyDescriptor, P = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Te(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (o = (r ? n(t, i, o) : n(o)) || o);
...
var He = Object.defineProperty, Me = Object.getOwnPropertyDescriptor, F = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? Me(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (o = (r ? n(t, i, o) : n(o)) || o);
  return r && o && He(t, i, o), o;
};
const Le = [1, 3, 6];
let O = class extends b {
  constructor() {
    super(...arguments), this.zone = "", this._pendingLow = null, this._pendingHigh = null, this._onSliderInput = (e) => {
      ...
      !this.hass || !this.zone || ze(this.hass, { zone: this.zone });
    }, this._onPickHours = (e) => {
  ...
  render() {
    ...
    return a`
      <div class="header-row">
        ...
        ${d ? a`<span class="action-chip" style="background:${$t(u)}"
              >${qt(u)}</span
            >` : p}
      </div>
      <div class="gauge-row">
...
var Ie = Object.defineProperty, Fe = Object.getOwnPropertyDescriptor, Xt = (e, t, i, r) => {
...
rt = Xt([
  y("comfort-band-profiles-tab")
], rt);
var Ve = Object.defineProperty, qe = Object.getOwnPropertyDescriptor, lt = (e, t, i, r) => {
  for (var o = r > 1 ? void 0 : r ? qe(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (o = (r ? n(t, i, o) : n(o)) || o);
  return r && o && Ve(t, i, o), o;
};
let B = class extends b {
  ...
  async _maybeMountGraph() {
    if (!(!this.entities?.roomTemperature || !this.hass)) {
      if (this._graphCard) {
  ...
  _graphEntities() {
    ...
    const e = [];
    return this.entities.roomTemperature && e.push({ entity: this.entities.roomTemperature, name: "Room" }), this.entities.effectiveLow && e.push({ entity: this.entities.effectiveLow, name: "Low" }), this.entities.effectiveHigh && e.push({ entity: this.entities.effectiveHigh, name: "High" }), this.entities.currentAction && e.push({ entity: this.entities.currentAction, name: "Action" }), e;
  }
  render() {
...
const Ze = 500, Ge = 1.5, Xe = 15, Mt = [0, 6, 12, 18, 24];
function Lt(e) {
  ...
  constructor() {
    super(...arguments), this.transitions = [], this._longPressTimer = null, this._onTrackTap = (e) => {
      ...
      for (const o of this.transitions) {
        const s = Lt(o.at);
        if (Math.abs(ut(s) - ut(r)) < Ge) return;
      }
      this.dispatchEvent(
  ...
  render() {
    return a`
      <div class="ruler">
        ...
        ${Mt.map((e, t) => {
      const i = t === 0 ? "hour-tick start" : t === Mt.length - 1 ? "hour-tick terminal" : "hour-tick";
...
var Qe = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, N = (e, t, i, r) => {
...
var si = Object.defineProperty, ni = Object.getOwnPropertyDescriptor, z = (e, t, i, r) => {
